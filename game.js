//global variables
//these two variables keep track of each colors 
//taken pieces so they can be added to each players score
//at the end of the game.
whiteCaptured =0;
blackCaptured =0;
//bool that keeps track of whose turn it is
var whoseTurn = true;
 //var that holds the contested KO position if there is one. 
 var ko =[[0,0]];
 //board array
 board = [];
$(document).ready(function() { 
    ...
    //draws game board, gets all legal positions,
    //fills board array
    drawBoard(context);
    var xpos = getPositions();
    var ypos =getPositions();
    board = createBoard();
    ...
    PlaceGamePiece = function(xPosit, yPosit, context, canvas) { 
        ...
        //if black's turn
            ...
            var captured = determineLiberties(xPosit, yPosit, "white");
        ...
        //if white's turn
            ...
            whoseTurn=true;
            var captured = determineLiberties(xPosit, yPosit, "black");
    ...
    removePieces= function(captured, color) {   
        ...
        incrementTaken(captured.length, color);
    };
